...
export default function Footer() {
  return (
    <footer>
      <div className="w-full h-[16vh] md:h-[8vh] bg-emerald-100 dark:bg-slate-700 text-black dark:text-white flex flex-col md:flex-row justify-between px-4 py-2 md:py-0  items-center">
        ...
        <div><p className="text-left center">
          Copyright © {new Date().getFullYear()}. Made with ♥ by Amine Braham
        </p>
        </div>
        <span className="hover:text-sky-400"><Link href="mailto:braham.amine@outlook.com"><a>Contact me !</a></Link></span>
      </div>
    </footer>
  );
}
