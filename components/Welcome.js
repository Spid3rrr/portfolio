...
export default function Welcome() {
  return (
    ...
    <div id="buttonContainer" className='flex flex-row justify-around pt-5'>
      <button className="text-base md:text-lg mx-2 rounded-full border-2 border-black dark:border-white  md:px-3 px-2 whitespace-nowrap hover:border-red-600 hover:text-white hover:bg-red-600 transition duration-500"><a download href="/Amine_Braham_CV.pdf" > My Resume </a></button>
      ...
      <button className="text-base md:text-lg mx-2 rounded-full border-2 border-black dark:border-white  md:px-3 px-2 whitespace-nowrap hover:border-amber-600 hover:text-white hover:bg-amber-600 transition duration-500"><a href="mailto:braham.amine@outlook.com" > Contact Me </a></button>     
    </div>
    </div>
  )
}
